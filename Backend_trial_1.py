...
BOT_LOGIC = [
    ...
    (["family", "plan"], "The Family Plan feature helps you store emergency contacts and meeting places."),
    (["live", "alerts"], "The Live Alerts section shows recent natural events using data from NASA."),
    (["emergency", "kit"], "Your emergency kit should contain water, food, a first-aid kit, and more."),
    (["quiz"], "You can test your knowledge by taking a preparedness quiz from the main dashboard."),
    (["hello", "hi", "hey"], "Hello! I am the Disastra assistant. Ask for 'help' to see what I know."),
