...
# --- MODIFIED: Chatbot logic is now more flexible with 'any' vs 'all' matching ---
BOT_LOGIC = [
    # Use 'any' for greetings, goodbyes, and single-topic queries
    ...
    # Use 'all' for specific topics that need combined keywords to be accurate
...
# --- MODIFIED: Chatbot handler now uses the new logic ---
