...
BOT_LOGIC = [
    ...
    (["emergency", "kit"], "Your emergency kit should contain water, food, a first-aid kit, a flashlight, and batteries. You can use the 'Emergency Kit' checklist on the dashboard to track your items."),
...
# --- HELPER FUNCTIONS & OTHER ROUTES (No changes) ---
...
def upload_picture(username):
    ...
    if file:
        ...
        file.save(file_path)
        # Add robust file handling here in a real app
